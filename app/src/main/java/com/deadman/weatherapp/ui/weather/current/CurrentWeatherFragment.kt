...
import com.deadman.weatherapp.R
import com.deadman.weatherapp.data.network.*
import com.deadman.weatherapp.internal.glide.GlideApp
import com.deadman.weatherapp.ui.base.ScopedFragment
...
class CurrentWeatherFragment : ScopedFragment(), KodeinAware{
    ...
    private fun chooseLocalizedUnitAbbreviation(metric: String, imperial: String): String {
        return if (viewModel.isMetrics) metric else imperial
    }
    ...
    private fun updateTemperatures(temperature: Double, feelsLike: Int) {
